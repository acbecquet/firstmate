...
FM_LOCK_PID=            # explicit fm-lock.sh session-lock holder for sessions whose tool shells lack the harness in their ancestry; honored only when it names a live, non-zombie harness process
